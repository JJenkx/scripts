...
# Install local user: wget -O -c https://raw.githubusercontent.com/JJenkx/Personal/main/apt_fast.sh -P "$HOME/.local/scripts" ; userhome="$HOME" ; sudo chmod +x "$userhome"/.local/scripts/apt_fast.sh
