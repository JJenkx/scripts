...
FILEPATTERN='x\w\w\.stackoverflow.com-PostHistory\.xz'
MATCH_7Z_REGEX="^.*\.7z$"
MATCH_XZ_REGEX="^.*\.xz$"
OPEN_OUT_FILE_WITH='codium'
OUTFILE='/home/jjenkx/stackoverflow.matches.txt'
WORKINGDIR='/run/media/jjenkx/624234a4-629f-4abd-9d5d-7ac85213bf4b/DB/stackoverflow/'




printf "\nThis script will search the 125GB stackoverflow dump using pcre2 regex\n\n"

# Prompt for regex input
IFS= read -rp 'Input pcre2 regex to search the stackoverflow dump:
