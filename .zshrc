...
alias webpng='find . -name "*.jpg" -print0 | parallel -j\+0 dwebp {} -o {.}.png'
...
# Deps Arch:
# sudo pacman -S imagemagick libwebp parallel
...
find "$PWD" -name "*" -type f -regextype posix-extended -iregex '.*\.(webp)$' -print0 | parallel -0 -j+0 --eta --bar '
